...
# %%
history = model.fit([train.user_id, train.movie_id], train.rating, epochs=15, verbose=1, validation_split=0.1)
...
print('MAE for testing: {}'.format(round(mean_absolute_error(y_true, model.predict([test.user_id, test.movie_id])),2)))
